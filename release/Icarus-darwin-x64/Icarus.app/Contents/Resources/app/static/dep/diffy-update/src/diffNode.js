define(['exports'], function (exports) {
  ...
  exports.isDiffNode = isDiffNode;
  exports.createDiffNode = createDiffNode;
  ...
  var IS_DIFF_NODE = Symbol('isDiffNode');
   ...
   */
  function createDiffNode(changeType, oldValue, newValue) {
    var _ref;

    return _ref = {}, _defineProperty(_ref, IS_DIFF_NODE, true), _defineProperty(_ref, 'changeType', changeType), _defineProperty(_ref, 'oldValue', oldValue), _defineProperty(_ref, 'newValue', newValue), _ref;
  }
});